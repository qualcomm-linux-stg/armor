...
public:
     ...
     */
    void processFile(std::string fileName, std::unique_ptr<clang::tooling::FixedCompilationDatabase> m_compDB);
     ...
     *         otherwise nullptr.
     */
    ASTNormalizedContext* getContext(llvm::StringRef fileName) const;
...
private:
    ...
    llvm::StringMap<std::unique_ptr<ASTNormalizedContext>> m_contexts;
};
